...
export class AppComponent {
  ...
  onLoad() {
    if (this.userHasUsed) return;

    this.getCookieConsent();
    this.getWarningCookie();

    setTimeout(() => {
      this.hasVariablesLoaded = true;
      this.userHasUsed = true;
    }, 3000);
  }
  ...
  public hasVariablesLoaded: boolean = false;
  private userHasUsed: boolean = false;
